...
window.addEventListener("load", () => {
    ...
    awards.addEventListener("input", (e) => {
        if(e.target.value < 0 || e.target.value > 10) {
            ...
            smallAwards.innerHTML = "El numero de premio tiene que estar entre 0 y 10"
    ...
    len.addEventListener("input", (e) =>{
        if(e.target.value < 60 || e.target.value > 360) {
            ...
            smallLen.innerHTML = "El numero de duracion tiene que estar entre 60 y 360"
            validate.len = false
    ...
    genre.addEventListener("input", (e) => {
        ...
        if(e.target.value < 1 || e.target.value > 12) {
            ...
            smallGenre.innerHTML = "Debe seleccionar un genero"
    ...
    form.addEventListener("submit", (e) => {
        ...
        for (let i = 0; i < inputs.length; i++){
            ...
            if (inputs[i].value === ""){
                ...
                small[i].innerHTML = "Este campo no debe estar vacio"
        ...
        if(select.value === "") {
            ...
            small[5].innerHTML = "Este campo no debe estar vacio"
